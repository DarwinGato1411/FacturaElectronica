 ...
 */
@Entity
@Table(name = "nota_venta_por_cobrar")
public class VistaNotaVentaPorCobrar implements Serializable {
...
//    @Size(min = 1, max = 12)
    ...
    public VistaNotaVentaPorCobrar(Long id, String facNumeroText, String cliCedula, String cliNombres, BigDecimal fac_total, BigDecimal facSaldoAmortizado, Integer dias, Date facFecha) {
        this.id = id;
    ...
    public VistaNotaVentaPorCobrar() {
    }
