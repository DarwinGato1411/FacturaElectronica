...
//    Button btnIngresoCompras;
    ...
    @Wire("#btnProdcutosVendidos")
    Menuitem btnProdcutosVendidos;
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        if (credential.getUsuarioSistema() != null) {
            ...
            if (credential.getUsuarioSistema().getUsuNivel() == 1) {
                ...
                btnProdcutosVendidos.setVisible(Boolean.TRUE);
            } else {
                btnFacturar.setVisible(Boolean.TRUE);
                menuVentas.setVisible(Boolean.TRUE);
                menuCompras.setVisible(Boolean.TRUE);
                ...
                btnListaCompras.setVisible(Boolean.FALSE);
                btnRetenciones.setVisible(Boolean.FALSE);
                btnProdcutosVendidos.setVisible(Boolean.FALSE);
            }
        }
    }
    ...
    @Listen("onClick = #btnProdcutosVendidos")
    public void btnProdcutosVendidos() {
        Executions.sendRedirect("/reportevistas/ventasproductos.zul");
    }
